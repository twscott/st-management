...
Write-Host $line80 -ForegroundColor Cyan
...
for ($i = 0; $i -lt $tests.Count; $i++) {
    ...
    Write-Host ""
    Write-Host $line60 -ForegroundColor DarkCyan
...
Write-Host $dashLine100 -ForegroundColor DarkGray
...
Write-Host $dashLine80 -ForegroundColor DarkGray
